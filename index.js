...
// sign B2Brazil private key (SF will then use B2Brazil public key)
...
const signAndEncrypt = (payload) => {
  const signed = jose.JWS.sign(payload, SIGNING_KEY) // verify it's from B2Brazil
